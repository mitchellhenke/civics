  ...
  defmodule Sqlite do
    ...
    defmodule Decoder do
      ...
      for {endian, modifier} <- [{1, quote(do: little)}, {0, quote(do: big)}] do
        def decode(
              <<0, unquote(endian)::unquote(modifier)-integer-unsigned,
                srid::32-unquote(modifier), _x_min::unquote(modifier)-float-64,
                _y_min::unquote(modifier)-float-64, _x_max::unquote(modifier)-float-64,
                _y_max::unquote(modifier)-float-64, 124, type::unquote(modifier)-32, rest::bits>>
            ) do
