defmodule Civics.StreetNameIndexer do
  # sqlite3 civics_dev.db '.headers OFF' 'select distinct street from assessments order by street' > ./priv/data/street_names_list.txt
